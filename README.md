...
| **Test Generation** | [Epic 5](https://github.com/liviuionesi/genesis/issues/5) | Planned | Mockito unit tests, `@DataJpaTest`/`@DataMongoTest` + Testcontainers, `@WebMvcTest`, generated in the same pass as the production code. Includes shared Testcontainers base class and mapper tests by default ([#24](https://github.com/liviuionesi/genesis/issues/24)), full-context integration tests ([#26](https://github.com/liviuionesi/genesis/issues/26)), DTO round-trip tests ([#27](https://github.com/liviuionesi/genesis/issues/27)), and performance test scaffold ([#28](https://github.com/liviuionesi/genesis/issues/28)). |
